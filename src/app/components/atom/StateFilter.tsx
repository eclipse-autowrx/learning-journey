      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg z-10 border border-neutral-200">
          <div className="p-4">
            ...
            {/* Select all checkbox */}
            <div className="mb-2">
              <label className="flex items-center cursor-pointer hover:bg-neutral-50 p-2 rounded">
                <input
                  type="checkbox"
                  checked={selectedStates.length === states.length}
                  onChange={handleSelectAll}
                  className="h-4 w-4 accent-primary-600 focus:ring-primary-500 border-neutral-300 rounded"
                />
                <span className="ml-2 text-sm font-medium text-neutral-700">Select All</span>
              </label>
            </div>
