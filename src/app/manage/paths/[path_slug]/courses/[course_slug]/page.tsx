            ...
            {activeTab === 'info' && (
              <div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <dl className="space-y-4">
                      ...
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-gray-900">{course.total_lessons || 0}</dd>
                      </div>
                    </dl>
                  </div>
                  ...
                  {/* Statistics & Media */}
                  <div>
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Statistics & Media</h3>
                    <dl className="space-y-4">
                      <div>
                      ...
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Enrollment Count</dt>
                        <dd className="mt-1 text-sm text-gray-900">{course.enrollment_count || 0}</dd>
                      </div>
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Completion Count</dt>
                        <dd className="mt-1 text-sm text-gray-900">{course.completion_count || 0}</dd>
                      </div>
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Icon</dt>
                        <dd className="mt-1 text-sm text-gray-900">{course.icon || '-'}</dd>
                      </div>
                      <div>
                        <dt className="text-sm font-medium text-gray-500">Top Icon</dt>
                        <dd className="mt-1 text-sm text-gray-900">{course.top_icon || '-'}</dd>
                      </div>
                      <div>
                          ...
                          <tr key={lesson._id} className="hover:bg-gray-50">
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                  <Link 
                                    href={`/manage/paths/${pathSlug}/courses/${courseSlug}/lessons/${lesson.slug}`}
