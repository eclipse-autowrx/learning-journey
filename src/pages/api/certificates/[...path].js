...
/**
 * API route to serve certificates from MEDIA_STORE_PATH/certificates
 ...
 * 
 * Usage: /api/certificates/pdf/filename.pdf (or /certificates/pdf/filename.pdf via rewrite)
 */
export default async function handler(req, res) {
    ...
    try {
        ...
        console.error('[api/certificates] Error serving file:', error);
